 ...
 * @author skuarch
 */
public class ControllerEditFilter {
    ...
    //==========================================================================
    public ControllerEditFilter(String id) throws Exception {
        this.id = id;
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    ...
                    gf.getjTextFieldName().setText((String) arrayList.get(0));
