 ...
 * @author skuarch
 */
public class ControllerEditServiceLevel extends Modeler {

    private ModelerServiceLevel modelerServiceLevel = new ModelerServiceLevel(null, true);
    private String id = null;

    //==========================================================================
    public ControllerEditServiceLevel(String id) throws Exception {
        super();
        this.id = id;
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                ...
                try {
                    ...
                    arrayList = requestData(id, "service level");
    ...
    public void setupButtonsInWindow() throws Exception {
        ...
        modelerServiceLevel.getjButton2().setText("save");
