...
public class LineChartPanelLive extends FactoryPanel {
    ...
    public LineChartPanelLive(SubPiece subPiece) throws Exception {
        ...
        this.lineChartLive = new LineChartLive(subPiece, subPiece.getView(), "", "", list, "live1" ,"live2");
                                ...
                                try {
                                    ...
                                    if (arrayList != null) {
                                        ...
                                        if (rtp != null && tmp != null) {
                                            ...
                                            lineChartLive.addSeries1(rtp, num);
                                        }
    ...
    private void changeChart() {
        ...
        Thread t = new Thread(new Runnable() {
            ...
            //==================================================================
            public void run() {
                lineChartLive.addSeries1(new Millisecond(), 0);
